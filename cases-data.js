...
window.CASES = [
  ...
  },
  {
    ...
    "desc": "Визуальный бренд музыкального объединения из Санкт-Петербурга: единое ядро, которое читается в айдентике каждой вечеринки и каждого релиза. Главный дизайнер бренда с 2023 года. За два года бренд вырос из логотипа и одного цвета в цельную систему — релизы, ивенты, соцсети, мерч.",
    "featured": true,
    "link": { "url": "https://www.behance.net/gallery/252269959/Brand-identity-Music-community", "label": "Полный кейс на Behance" },
    "details": {
      "roleIntro": "Отвечаю за визуальный язык объединения — от логики бренда до афиш, обложек и соцсетей. Работаю в связке с продюсерами, фотографами и видеографами; в 2025 году сама наняла дизайнера-помощника и веду его работу.",
      "role": [
        "айдентика бренда и её развитие;",
        "айдентика ивентов — у каждой вечеринки своя тема;",
        "3D-обложки релизов и 2D-обложки миксов (Blender);",
        "2D/3D-анимация для видео и дизайн соцсетей;",
        "мерч и стикеры — от наклеек до 3D-печатных брелоков."
      ],
      "gallery1": ["assets/se-mashup.jpg", "assets/se-cover.jpg", "assets/se-cover-fall.jpg", "assets/se-cover-ifs.jpg", "assets/se-mix.jpg"],
      "task": "У каждого события и релиза СЕАНСа своя тема и своё оформление. Задача — не сводить их к одному шаблону, а построить систему, в которой у каждого ивента собственная айдентика, но за ней всегда читается СЕАНС.",
      "solutionIntro": "Константы бренда держат узнаваемость, пока всё остальное меняется под тему:",
      "solution": [
        "Ядро | кобальтовый синий, пластичный «жидкий» логотип, чёрно-белые halftone-объекты и рукописный акцидентный шрифт.",
        "Ивенты | «СЕАНС × Институт» в «казённой» эстетике выпускного альбома, камерный Evening Coffee Club, гоночный «СЕАНС у Флэт» — три темы, один узнаваемый бренд.",
        "Обложки | базовая 3D-сцена в Blender постоянна, издания различаются деталями: кленовый лист осеннего выпуска, стикер коллаборации с ITMO Fashion Show."
      ],
      "closing": "Результат: сообщество выросло примерно втрое — с ~300 до 900+ подписчиков, вечеринки собирают 200–300 гостей; бренд работал на удержание и узнаваемость на этом росте.",
